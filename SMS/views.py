...
class pdf_report(TemplateView):
    def get(self, request, claim):
        ...
        d5_tasks_occ = Task.objects.filter(project=claim, subproject='D5 Occurence', closed=False, status='ALL').order_by('date_issued')
        d5_tasks_done_occ = Task.objects.filter(project=claim, subproject='D5 Occurence', closed = True, status='ALL').order_by('date_issued')
        ...
        d6_tasks_occ = Task.objects.filter(project=claim, subproject='D6 Occurence', closed=False, status='ALL').order_by('date_issued')
        d6_tasks_done_occ = Task.objects.filter(project=claim, subproject='D6 Occurence', closed = True, status='ALL').order_by('date_issued')
